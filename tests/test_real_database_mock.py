...
class TestRealisticDatabaseMocks:
    ...
    def test_realistic_database_handles_various_file_formats(
        self, realistic_rekordbox_db
    ):
    ...
    def test_realistic_database_handles_complex_folder_structure(
        self, realistic_rekordbox_db
    ):
        ...
        artist_folders = [
            ...
            if any(
                artist in path
                for artist in ["deadmau5", "Daft Punk", "Dr. Dre", "Eminem", "Avicii"]
            )
        ]
